...
export const FEATURED = {
  project: <ProjectCard>{
    ...
    outcome: "Static-first credibility + embedded proof-of-work demos, deployed behind Nginx with atomic releases.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Result",
        body: [
          "Readable technical narrative suitable for review and extension.",
        ],
      },
    ],
  },
